    ...
    <div className={`relative flex min-h-screen items-center justify-center px-4 overflow-hidden transition-colors duration-300 ${
      ...
      >
        ...
        <div className="mb-6 text-center">
          ...
          <div
            className={`inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-mono font-medium mb-2 border ${
              isDark
          ...
          >
            Welcome to gyan<span className="text-emerald-500">.ai</span>
          </h1>
          <p className={`mt-1 text-xs ${isDark ? 'text-emerald-200/70' : 'text-emerald-700/80'}`}>
            Enter the Living 3D Knowledge Forest & Study Engine
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading ? (
              ...
              <>
                <span>Enter Knowledge Grove</span>
