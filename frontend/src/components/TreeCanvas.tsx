...
export default function TreeCanvas({
  ...
  useEffect(() => {
    ...
    const trunkMaterials: THREE.Material[] = [];
    ...
    const rootBranchLines: THREE.Vector3[] = [];
    ...
    const branchLines: THREE.Vector3[] = [];
    ...
    // 7. Dynamic Bioluminescent Spores & Fluttering Canopy Energy
    // Background cylinder shadow trees removed to keep the view clean and unblocked.

    // 8. Forest Floor Glowing Reflection Disc
    ...
    // 10. Mouse Interaction & Camera Parallax
    ...
    const animate = () => {
      ...
      const sporePosAttr = sporeGeo.attributes.position as THREE.BufferAttribute;
      const sporeArray = sporePosAttr.array as Float32Array;
...
function createSporeTexture(isDark: boolean): THREE.Texture {
